<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"> Admin Panel (Voter Acquisition) </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li ><a href="./dashboard.php">Home <span class="sr-only">(current)</span></a></li>
          ...
          <li><a href="./todays_birthday.php">Today's Birthday</a></li>
		  <li><a href="./updatenews.php">Posted News</a></li>
		  <li><a href="./updatecatagory.php">Add Category</a></li>
      </ul>

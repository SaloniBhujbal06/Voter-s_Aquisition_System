...
<html lang="en">
<head>
<title> Sign Up | College Administration System |  </title>
...
<div class="panel panel-info" style="border-color: #10191d;">
      <div class="panel-heading" align="center" style="color: #ffffff;background-color: #10191d;border-color: #10191d;">Create User Account</div>
...
<h5 ng-show="val2" id="msg">  </h5>
  ...
  <div class="form-group" align="center">
    <button type="submit" class="btn btn-info" name="submit">Add User</button>
  </div>
...
<div class="col-md-8">
<div class="panel panel-info" style="border-color: #10191d;">
      <div class="panel-heading" align="center" style="color: #ffffff;background-color: #10191d;border-color: #10191d;">User Details</div>
      <div class="panel-body">
